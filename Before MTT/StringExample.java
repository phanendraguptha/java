...
System.out.println("s5 is greater than s7."+s5.compareTo(s7));
}
else if (s5.compareTo(s7) == 0) {
System.out.println("s5 andn s7 have the same contents."+s5.compareTo(s7));
}
else
System.out.println("s5 is less than s7."+s5.compareTo(s7)); //-7
